    ...
    <section className="py-20 px-4 bg-slate-950">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16 text-center">
          <p className="text-emerald-400 text-sm font-semibold tracking-wider uppercase mb-3">Our Vision, Mission and Values</p>
          ...
          <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto text-pretty leading-relaxed">
           At Oakwood ESL, our mission is to provide holistic, inclusive support for all students to achieve their goals of communicating in English and to grow their unique 
           talents so that they find joy and fulfillment in higher education, career, and life
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6">
          {/* Row 1: Mission Statement - Large focal point */}
          <BentoTilt className="md:col-span-8 h-[500px] md:h-[600px]">
            <BentoCard
              src="/assets/photo_2025-11-09_11-31-47.jpg"
              isImage={true}
          ...
          {/* Row 2: Three Equal Cards for Vision, Excellence, Community */}
          <BentoTilt className="md:col-span-4 h-[380px]">
            <BentoCard
              src="/assets/photo_2025-11-09_11-31-50.jpg"
              isImage={true}
          ...
          <BentoTilt className="md:col-span-4 h-[380px]">
            <BentoCard
              src="/assets/photo_2025-11-09_11-29-55.jpg"
              isImage={true}
