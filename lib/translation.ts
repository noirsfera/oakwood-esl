...
export const translations = {
  ru: {
    ...
    home: {
      ...
      hero: {
        title: 'Изучение английского языка с очень современным',
        titleHighlight: 'подходом',
        subtitle: 'Научитесь общаться на английском с настоящими носителями языка.',
    ...
    booking: {
      ...
      form: {
        ...
        trial: 'Только пробный урок (скидка 50%)',
        starter: 'Стартовый пакет (8 уроков)',
        standard: 'Стандартный пакет (16 уроков)',
        intensivePackage: 'Интенсивный пакет (24 урока)',
        unlimited: 'Безлимитный на месяц',
  ...
  en: {
    ...
    home: {
      ...
      hero: {
        title: 'English learning with a very modern',
        titleHighlight: 'edge',
        subtitle: 'Learn how to communicate in English with real native speakers.',
    ...
    booking: {
      ...
      form: {
        ...
        intensivePackage: 'Intensive Package (24 lessons)',
